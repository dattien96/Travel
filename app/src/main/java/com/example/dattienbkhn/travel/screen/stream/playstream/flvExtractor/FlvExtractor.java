 ...
 */
package com.example.dattienbkhn.travel.screen.stream.playstream.flvExtractor;
...
public final class FlvExtractor implements Extractor, SeekMap {
  ...
  public static final ExtractorsFactory FACTORY = new ExtractorsFactory() {
    ...
    public Extractor[] createExtractors() {
      return new Extractor[] {new com.example.dattienbkhn.travel.screen.stream.playstream.flvExtractor.FlvExtractor()};
    }
