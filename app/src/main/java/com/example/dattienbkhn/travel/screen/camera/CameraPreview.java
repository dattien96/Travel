...
public class CameraPreview  extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        ...
        parameters.setPreviewSize(size.get(4).width,size.get(4).height);
       // parameters.setPictureSize(400, 400);
       // Camera.Size optimalSize = CameraPreview.getOptimalPreviewSize(sizes, getResources().getDisplayMetrics().widthPixels, getResources().getDisplayMetrics().heightPixels);
